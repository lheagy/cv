...
\NewEnviron{entryleft}{
    \vspace{-0.3cm}
    \begin{tabularx}{\textwidth}{@{}p{0.87\textwidth} p{0.13\textwidth}}
        \BODY
    \end{tabularx}
    \vspace{-0.2cm}
...
\newenvironment{myquote}%
  {\list{}{\leftmargin=0.5cm\rightmargin=0.5cm}\item[]}%
  {\endlist}

\NewEnviron{myitemize}{
    \vspace{-0.18cm}
    \begin{itemize}[topsep=0pt,itemsep=0.3pt,leftmargin=0.75cm]
        \BODY
    \end{itemize}
    % \vspace{-0.1cm}
}

\NewEnviron{mycompactitemize}{
    \vspace{-0.18cm}
    \begin{itemize}[topsep=0pt,itemsep=0.1pt]
        \BODY
    \end{itemize}
    % \vspace{-0.1cm}
}
...
\NewEnviron{myenumerate}{
    \vspace{-0.2cm}
    \begin{enumerate}[topsep=0pt, itemsep=0.3pt]
        \BODY
    \end{enumerate}
    % \vspace{-0.3cm}
}
...
& Thesis: \emph{Electromagnetic imaging for subsurface injections} \\
...
\begin{entryright}
    % \tworow{Apr. 2016 -- \\ Sep. 2017}
    2016 -- 2017
    & \textbf{Aranz Geo Canada Limited} (Calgary, AB) \\
...
\begin{entryright}
    % \tworow{Nov. 2015 -- \\ Apr. 2016} &
    2015 -- 2016
    & \textbf{3point Science Inc} (Calgary, AB) \\
...
\begin{entryright}
    \tworow{2014 \\ Jun. -- Aug.}
    & \textbf{Schlumberger Doll Research} (Boston, MA) \\
    & Geophysics Intern \\
    % \if\descriptions
    % & \begin{myitemize}
...
\begin{entryright}
    \tworow{2013 \\ Jun. -- Aug.}
    & \textbf{Schlumberger Electromagnetic Imaging} (Richmond, CA) \\
    & Geophysics Intern \\
    % \if\descriptions
    % & \begin{myitemize}
...
\begin{entryright}
    \tworow{2012 \\ May -- Aug.}
    & \textbf{ConocoPhillips Canada} (Calgary, AB) \\
...
\begin{entryright}
    \tworow{2011 \\ May -- Aug.}
    & \textbf{Alfred Wegener Institute of Polar and Marine Research} (Bremerhaven, Germany) \\
    & Geophysics Summer Student \\
    % \if\descriptions
    % & \begin{myitemize}
...
This paper presents an argument for open-source software and open-science practices to progress collaborative, multidisciplinary research in the geosciences. We provide examples of the benefits of adopting such a model based on our experience with the SimPEG project; including streamlined collaboration and transfer of methodological advances between domains of geophysics, reduced implementation-overhead for students and researchers interested in building upon previous work and the ability to quickly disseminate reproducible results.
\\
...
% presented at \emph{the Multidisciplinary Undergraduate Research Conference at the University of British Columbia}
\end{entryright}
