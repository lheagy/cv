...
\usepackage[margin=2cm,top=2.25cm,bottom=2.25cm]{geometry}
% \newif\ifdescriptions
% \descriptionsfalse
% \descriptionstrue
...
& Themes: Machine learning in the physical sciences, interactive computing, statistical techniques for geoscience, open and reproducible research, data science education
\end{entryright}
...
% This study shows that a moderately conductive and chargeable target in a resistive host is an ideal scenario for generating strong induced polarization signals.
