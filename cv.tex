...
\cfoot{\HelveticaNeueUltraLight\thepage \hspace{1pt} of \pageref{LastPage} }
...
& \myindent{Thesis: \emph{Electromagnetic methods for imaging subsurface injections
}} \\
& \myindent{intended submission: June 1, 2018}
\end{entryright}
...
\subheading{Peer Reviewed Publications (submitted or in review)}
    ...
    \begin{myenumerate}
        \item \bibentry{cockett2018richards}
    \end{myenumerate}
